...
public class KhoaHocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcvkhoahoc = findViewById(R.id.rcv_khoahoc);
    ...
    private void getListPost() {
        Api.api.getPostkhoahoc().enqueue(new Callback<List<Post>>() {
            @Override
            public void onResponse(Call<List<Post>> call, Response<List<Post>> response) {
                if(response.code()!=200){
                    Toast.makeText(KhoaHocActivity.this, "Error::"+response.errorBody(), Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            public void onFailure(Call<List<Post>> call, Throwable t) {
                Toast.makeText(KhoaHocActivity.this, "Call api error"+t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void setDataforAdapter(List<Post> mListPost) {
        ...
        rcvkhoahoc.setLayoutManager(new LinearLayoutManager(this));
        rcvkhoahoc.setAdapter(postAdapter);
