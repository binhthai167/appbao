...
public class GiaiTriActivity extends AppCompatActivity {
    private RecyclerView rcvgiaitri;
    List<Post> mListPost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcvgiaitri = findViewById(R.id.rcv_giaitri);
    ...
    private void getListPost() {
        Api.api.getPostgiaitri().enqueue(new Callback<List<Post>>() {
            @Override
            public void onResponse(Call<List<Post>> call, Response<List<Post>> response) {
                if(response.code()!=200){
                    Toast.makeText(GiaiTriActivity.this, "Error::"+response.errorBody(), Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            public void onFailure(Call<List<Post>> call, Throwable t) {
                Toast.makeText(GiaiTriActivity.this, "Call api error"+t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void setDataforAdapter(List<Post> mListPost) {
        ...
        rcvgiaitri.setLayoutManager(new LinearLayoutManager(this));
        rcvgiaitri.setAdapter(postAdapter);
